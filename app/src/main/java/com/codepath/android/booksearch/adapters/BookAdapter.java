...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public RelativeLayout rlBookRelative;
        ...
        public ViewHolder(View itemView) {
            ...
            rlBookRelative = (RelativeLayout) itemView.findViewById(R.id.rlBookRelative);
        }
    }
    ...
    public void onBindViewHolder(BookAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.rlBookRelative.setOnClickListener(new View.OnClickListener() {
            @Override
